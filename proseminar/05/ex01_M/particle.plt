...
set xrange [-100.5:100.5] # print data values for x axis from range [-0.5:100.5]
set yrange [-100.5:100.5] # print data values for y axis from range [-0.5:100.5]
set zrange [-100.5:100.5] # print data values for z axis from range [-0.5:100.5]
